...
export const SaleReservation: CollectionConfig = {
  slug: 'salereservation',
  access: {
    read: () => true,
    create: () => true,
    update: () => true,
  ...
  labels: {
    singular: 'Reservación vehicular',
    plural: 'Reservaciones vehiculares',
  },
  fields: [
    {
      type: 'row',
    ...
    {
      name: 'condition',
      label: 'Condición de reservación',
      type: 'group',
      fields: [
        {
          type: 'row',
        ...
        },
        {
          ...
          label: 'Observaciones de condición de reserva',
          type: 'textarea',
          required: false,
        },
      ],
    ...
    },
    {
      ...
      required: false,
      admin: {
        description: 'Pagos realizados para reservar la unidad vehicular',
      },
      fields: [
        {
          type: 'row',
