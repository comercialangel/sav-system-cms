...
export const LicensePlateIssuanceProcedure: CollectionConfig = {
  ...
  //         const { payload } = req
  //         try {
  //           // Obtener el procedimiento de inscripción vehicular relacionado
  //           const vehicleRegistration = await payload.findByID({
  //             collection: 'vehicleregistrationprocedure',
  //             id: doc.vehicleregistration,
  //             depth: 1,
  //           })

  //           // Actualizar el vehículo relacionado con este procedimiento
  //           const vehicleId =
  //             typeof vehicleRegistration.vehicle === 'string'
  //               ? vehicleRegistration.vehicle
  //               : vehicleRegistration.vehicle.id
  //           await payload.update({
  //             collection: 'vehicle',
  //             id: vehicleId,
  //             data: {
  //               licensePlates: {
  //                 licensePlateIssuanceProcedure: doc.id, // Asignar el ID del nuevo procedimiento
  //               },
  //             },
  //           })
  //         } catch (error) {
  //           console.error('Error enviando id de trámite de placas a vehículo:', error)
  //         }
  //       }
  //     },
  //   ],
  ...
  //         if (vehicleRegistration.vehicle) {
  //           const vehicleId =
  //             typeof vehicleRegistration.vehicle === 'string'
  //               ? vehicleRegistration.vehicle
  //               : vehicleRegistration.vehicle.id
  ...
  //             data: {
  //               licensePlates: {
  //                 licensePlateIssuanceProcedure: null,
  //               },
  //             },
  //           })
  //         }
  //       } catch (error) {
  //         console.error('Error limpiando referencia de trámite de placas en vehículo:', error)
  //       }
  //     },
  //   ],
  // },
